...
[![iStore使用文档](https://img.shields.io/badge/使用文档-iStore%20OS-brightgreen?style=flat-square)](https://doc.linkease.com/zh/guide/istoreos) [![最新固件下载](https://img.shields.io/github/v/release/AstroProfundis/openwrt-actions?style=flat-square&label=最新固件下载)](../../releases/latest)
...
- IP: `http://172.23.33.1` or `http://iStoreOS.lan/`
- 用户名: `root`
- 密码: `password`
